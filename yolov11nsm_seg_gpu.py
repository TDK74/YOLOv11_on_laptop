...
# load YOLO11n-seg
# model = YOLO('yolo11n-seg.pt').to('cuda')  # transfer the model to GPU
# load YOLO11s-seg
# model = YOLO('yolo11s-seg.pt').to('cuda')  # transfer the model to GPU
# load YOLO11m-seg
model = YOLO('yolo11m-seg.pt').to('cuda')  # transfer the model to GPU
